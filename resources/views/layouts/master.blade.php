...
<head>
    ...
    <title>@yield('title', 'MyLibry - Home')</title>
    <!-- Favicon icon -->
...
<section class="header py-2 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="headings">
                    <h3><a href="{{route('bookshop.home')}}" class="text-secondary"><b class="text-danger">My</b>Libry</a></h3>
                </div>
            </div>
            <div class="col-md-4">
...
<footer class="py-3 text-center border-top bg-light">
    <div class="container">
        ...
        <!-- <div class="footer-text">
            Copyright &copy; Dammy - <span id="year"></span>
        </div> -->
    </div>
</footer>
